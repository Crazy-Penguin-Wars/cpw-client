   ...
   public final class EdgeList
   {
      ...
      public static function fromArray(param1:Array) : EdgeList
      {
         ...
         while(_loc3_ < param1.length)
         {
            ...
            {
               Boot.lastError = new Error();
               throw "Error: Array contains non " + "Edge" + " types.";
            }
            _loc2_.push(_loc4_);
         }
         return _loc2_;
      ...
      public function unshift(param1:Edge) : Boolean
      {
         ...
         {
            Boot.lastError = new Error();
            throw "Error: " + "Edge" + "List is immutable";
         }
      ...
      public function toString() : String
      {
         var _loc4_:* = null as Edge;
         var _loc5_:int = 0;
         var _loc6_:* = null as EdgeList;
         var _loc1_:String = "[";
         var _loc2_:Boolean = true;
         zpp_inner.valmod();
         var _loc3_:EdgeIterator = EdgeIterator.get(this);
         while(true)
         {
            ...
            if(!(_loc3_.zpp_i < _loc5_ ? true : (_loc3_.zpp_next = EdgeIterator.zpp_pool, EdgeIterator.zpp_pool = _loc3_, _loc3_.zpp_inner = null, false)))
            {
               break;
            }
      ...
      public function merge(param1:EdgeList) : void
      {
         ...
         var _loc2_:EdgeIterator = EdgeIterator.get(param1);
         while(true)
         {
            ...
            if(!(_loc2_.zpp_i < _loc4_ ? true : (_loc2_.zpp_next = EdgeIterator.zpp_pool, EdgeIterator.zpp_pool = _loc2_, _loc2_.zpp_inner = null, false)))
            {
               break;
            }
      ...
      public function foreach(param1:Function) : EdgeList
      {
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc6_:* = null as EdgeList;
         ...
         while(true)
         {
            ...
            _loc3_.zpp_critical = true;
            if(!(_loc3_.zpp_i < _loc4_ ? true : (_loc3_.zpp_next = EdgeIterator.zpp_pool, EdgeIterator.zpp_pool = _loc3_, _loc3_.zpp_inner = null, false)))
            {
               break;
            }
            try
