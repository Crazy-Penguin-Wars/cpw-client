package nape.shape
{
   ...
   public final class ShapeList
   {
      ...
      public function toString() : String
      {
         ...
         zpp_inner.valmod();
         var _loc3_:ShapeIterator = ShapeIterator.get(this);
         while(true)
         {
            ...
            if(!(_loc3_.zpp_i < _loc5_ ? true : (_loc3_.zpp_next = ShapeIterator.zpp_pool, ShapeIterator.zpp_pool = _loc3_, _loc3_.zpp_inner = null, false)))
            {
               break;
            }
      ...
      public function merge(param1:ShapeList) : void
      {
         ...
         var _loc2_:ShapeIterator = ShapeIterator.get(param1);
         while(true)
         {
            ...
            if(!(_loc2_.zpp_i < _loc4_ ? true : (_loc2_.zpp_next = ShapeIterator.zpp_pool, ShapeIterator.zpp_pool = _loc2_, _loc2_.zpp_inner = null, false)))
            {
               break;
            }
      ...
      public function foreach(param1:Function) : ShapeList
      {
         ...
         while(true)
         {
            ...
            _loc3_.zpp_critical = true;
            if(!(_loc3_.zpp_i < _loc4_ ? true : (_loc3_.zpp_next = ShapeIterator.zpp_pool, ShapeIterator.zpp_pool = _loc3_, _loc3_.zpp_inner = null, false)))
            {
               break;
            }
            try
