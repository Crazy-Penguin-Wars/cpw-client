package nape.phys
{
   ...
   public final class BodyList
   {
      ...
      public static function fromArray(param1:Array) : BodyList
      {
         ...
         while(_loc3_ < param1.length)
         {
            ...
            {
               Boot.lastError = new Error();
               throw "Error: Array contains non " + "Body" + " types.";
            }
            _loc2_.push(_loc4_);
         }
         return _loc2_;
      ...
      public static function fromVector(param1:Vector.<Body>) : BodyList
      {
         var _loc4_:* = null as Body;
         if(param1 == null)
         {
      ...
      public function unshift(param1:Body) : Boolean
      {
         if(zpp_inner.immutable)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Body" + "List is immutable";
         }
      ...
      public function toString() : String
      {
         ...
         zpp_inner.valmod();
         var _loc3_:BodyIterator = BodyIterator.get(this);
         while(true)
         {
            ...
            if(!(_loc3_.zpp_i < _loc5_ ? true : (_loc3_.zpp_next = BodyIterator.zpp_pool, BodyIterator.zpp_pool = _loc3_, _loc3_.zpp_inner = null, false)))
            {
               break;
            }
      ...
      {
         var _loc2_:* = null as ZNPNode_ZPP_Body;
      ...
      public function remove(param1:Body) : Boolean
      {
         ...
         var _loc3_:ZNPNode_ZPP_Body = zpp_inner.inner.head;
         while(_loc3_ != null)
         {
            _loc4_ = _loc3_.elt;
      ...
      public function push(param1:Body) : Boolean
      {
         if(zpp_inner.immutable)
         {
            Boot.lastError = new Error();
      ...
      public function merge(param1:BodyList) : void
      {
         var _loc3_:* = null as Body;
         var _loc4_:int = 0;
         ...
         var _loc2_:BodyIterator = BodyIterator.get(param1);
         while(true)
         {
            ...
            if(!(_loc2_.zpp_i < _loc4_ ? true : (_loc2_.zpp_next = BodyIterator.zpp_pool, BodyIterator.zpp_pool = _loc2_, _loc2_.zpp_inner = null, false)))
            {
               break;
            }
      ...
      public function iterator() : BodyIterator
      {
         zpp_inner.valmod();
         return BodyIterator.get(this);
      }
      
      public function has(param1:Body) : Boolean
      {
         zpp_inner.valmod();
      ...
      public function foreach(param1:Function) : BodyList
      {
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc6_:* = null as BodyList;
         ...
         while(true)
         {
            ...
            _loc3_.zpp_critical = true;
            if(!(_loc3_.zpp_i < _loc4_ ? true : (_loc3_.zpp_next = BodyIterator.zpp_pool, BodyIterator.zpp_pool = _loc3_, _loc3_.zpp_inner = null, false)))
            {
               break;
            }
            try
      ...
      public function filter(param1:Function) : BodyList
      {
         var _loc4_:* = null as Body;
         var _loc5_:* = null;
         if(param1 == null)
      ...
      public function copy(param1:Boolean = false) : BodyList
      {
         var _loc4_:* = null as Body;
         var _loc5_:int = 0;
         var _loc6_:* = null as BodyList;
      ...
      public function at(param1:int) : Body
      {
         zpp_inner.valmod();
      ...
      public function add(param1:Body) : Boolean
      {
