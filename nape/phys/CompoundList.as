package nape.phys
{
   ...
   public final class CompoundList
   {
      ...
      public var zpp_inner:ZPP_CompoundList;
      ...
      public static function fromArray(param1:Array) : CompoundList
      {
         ...
         var _loc2_:CompoundList = new CompoundList();
         var _loc3_:int = 0;
         while(_loc3_ < param1.length)
         {
            _loc4_ = param1[_loc3_];
            _loc3_++;
            if(!(_loc4_ is Compound))
            {
               Boot.lastError = new Error();
               throw "Error: Array contains non " + "Compound" + " types.";
            }
            _loc2_.push(_loc4_);
         }
         return _loc2_;
      ...
      public static function fromVector(param1:Vector.<Compound>) : CompoundList
      {
         var _loc4_:* = null as Compound;
         if(param1 == null)
         {
      ...
      public function unshift(param1:Compound) : Boolean
      {
         if(zpp_inner.immutable)
         {
            Boot.lastError = new Error();
            throw "Error: " + "Compound" + "List is immutable";
         }
      ...
      public function toString() : String
      {
         var _loc4_:* = null as Compound;
         var _loc5_:int = 0;
         var _loc6_:* = null as CompoundList;
         var _loc1_:String = "[";
         var _loc2_:Boolean = true;
         zpp_inner.valmod();
         var _loc3_:CompoundIterator = CompoundIterator.get(this);
         while(true)
         {
            ...
            if(!(_loc3_.zpp_i < _loc5_ ? true : (_loc3_.zpp_next = CompoundIterator.zpp_pool, CompoundIterator.zpp_pool = _loc3_, _loc3_.zpp_inner = null, false)))
            {
               break;
            }
      ...
      public function remove(param1:Compound) : Boolean
      {
         ...
         var _loc3_:ZNPNode_ZPP_Compound = zpp_inner.inner.head;
         while(_loc3_ != null)
         {
            _loc4_ = _loc3_.elt;
      ...
      public function push(param1:Compound) : Boolean
      {
         if(zpp_inner.immutable)
         {
            Boot.lastError = new Error();
      ...
      public function merge(param1:CompoundList) : void
      {
         var _loc3_:* = null as Compound;
         var _loc4_:int = 0;
         var _loc5_:* = null as CompoundList;
         if(param1 == null)
         {
            Boot.lastError = new Error();
         ...
         var _loc2_:CompoundIterator = CompoundIterator.get(param1);
         while(true)
         {
            ...
            if(!(_loc2_.zpp_i < _loc4_ ? true : (_loc2_.zpp_next = CompoundIterator.zpp_pool, CompoundIterator.zpp_pool = _loc2_, _loc2_.zpp_inner = null, false)))
            {
               break;
            }
      ...
      public function iterator() : CompoundIterator
      {
         zpp_inner.valmod();
         return CompoundIterator.get(this);
      }
      
      public function has(param1:Compound) : Boolean
      {
         zpp_inner.valmod();
      ...
      public function foreach(param1:Function) : CompoundList
      {
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc6_:* = null as CompoundList;
         ...
         while(true)
         {
            ...
            _loc3_.zpp_critical = true;
            if(!(_loc3_.zpp_i < _loc4_ ? true : (_loc3_.zpp_next = CompoundIterator.zpp_pool, CompoundIterator.zpp_pool = _loc3_, _loc3_.zpp_inner = null, false)))
            {
               break;
            }
            try
      ...
      public function filter(param1:Function) : CompoundList
      {
         var _loc4_:* = null as Compound;
         var _loc5_:* = null;
         if(param1 == null)
      ...
      public function copy(param1:Boolean = false) : CompoundList
      {
         var _loc4_:* = null as Compound;
         var _loc5_:int = 0;
         var _loc6_:* = null as CompoundList;
      ...
      public function at(param1:int) : Compound
      {
         zpp_inner.valmod();
      ...
      public function add(param1:Compound) : Boolean
      {
