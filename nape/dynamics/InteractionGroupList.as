package nape.dynamics
{
   ...
   public final class InteractionGroupList
   {
      ...
      public static function fromArray(param1:Array) : InteractionGroupList
      {
         ...
         while(_loc3_ < param1.length)
         {
            ...
            _loc3_++;
            if(!(_loc4_ is InteractionGroup))
            {
               Boot.lastError = new Error();
               throw "Error: Array contains non " + "InteractionGroup" + " types.";
            }
            _loc2_.push(_loc4_);
         }
         return _loc2_;
      ...
      public function unshift(param1:InteractionGroup) : Boolean
      {
         ...
         {
            Boot.lastError = new Error();
            throw "Error: " + "InteractionGroup" + "List is immutable";
         }
      ...
      public function toString() : String
      {
         var _loc4_:* = null as InteractionGroup;
         var _loc5_:int = 0;
         var _loc6_:* = null as InteractionGroupList;
         var _loc1_:String = "[";
         var _loc2_:Boolean = true;
         zpp_inner.valmod();
         var _loc3_:InteractionGroupIterator = InteractionGroupIterator.get(this);
         while(true)
         {
            ...
            if(!(_loc3_.zpp_i < _loc5_ ? true : (_loc3_.zpp_next = InteractionGroupIterator.zpp_pool, InteractionGroupIterator.zpp_pool = _loc3_, _loc3_.zpp_inner = null, false)))
            {
               break;
            }
      ...
      public function merge(param1:InteractionGroupList) : void
      {
         var _loc3_:* = null as InteractionGroup;
         var _loc4_:int = 0;
         var _loc5_:* = null as InteractionGroupList;
         if(param1 == null)
         {
            Boot.lastError = new Error();
         ...
         var _loc2_:InteractionGroupIterator = InteractionGroupIterator.get(param1);
         while(true)
         {
            ...
            if(!(_loc2_.zpp_i < _loc4_ ? true : (_loc2_.zpp_next = InteractionGroupIterator.zpp_pool, InteractionGroupIterator.zpp_pool = _loc2_, _loc2_.zpp_inner = null, false)))
            {
               break;
            }
      ...
      public function foreach(param1:Function) : InteractionGroupList
      {
         var _loc4_:int = 0;
         var _loc5_:* = null;
         var _loc6_:* = null as InteractionGroupList;
         ...
         while(true)
         {
            ...
            _loc3_.zpp_critical = true;
            if(!(_loc3_.zpp_i < _loc4_ ? true : (_loc3_.zpp_next = InteractionGroupIterator.zpp_pool, InteractionGroupIterator.zpp_pool = _loc3_, _loc3_.zpp_inner = null, false)))
            {
               break;
            }
            try
