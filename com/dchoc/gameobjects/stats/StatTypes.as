package com.dchoc.gameobjects.stats
{
   ...
   public class StatTypes
   {
      ...
      public static function getStatGroupByType(param1:String) : String
      {
         switch(param1)
         {
            case "Weapon":
            ...
            default:
               LogUtils.log("No defined type name: " + param1 + " check typing, so using GROUP_BASE","StatTypes",2,"Stats",false,false);
               return "Group_Base";
         }
      }
   }
