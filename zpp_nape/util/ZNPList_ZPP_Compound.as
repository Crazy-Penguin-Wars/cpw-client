package zpp_nape.util
{
   ...
   public class ZNPList_ZPP_Compound
   {
      ...
      public function inlined_pop_unsafe() : ZPP_Compound
      {
         var _loc1_:ZPP_Compound = head.elt;
         pop();
         return _loc1_;
      ...
      public function inlined_insert(param1:ZNPNode_ZPP_Compound, param2:ZPP_Compound) : ZNPNode_ZPP_Compound
      {
         var _loc4_:* = null as ZNPNode_ZPP_Compound;
         if(ZNPNode_ZPP_Compound.zpp_pool == null)
         {
      ...
      public function inlined_has(param1:ZPP_Compound) : Boolean
      {
      ...
      public function inlined_erase(param1:ZNPNode_ZPP_Compound) : ZNPNode_ZPP_Compound
      {
      ...
      public function inlined_add(param1:ZPP_Compound) : ZPP_Compound
      {
         var _loc3_:* = null as ZNPNode_ZPP_Compound;
         if(ZNPNode_ZPP_Compound.zpp_pool == null)
         {
