package zpp_nape.util
{
   ...
   public class ZPP_Set_ZPP_SimpleEvent
   {
      
      public static var zpp_pool:ZPP_Set_ZPP_SimpleEvent = null;
      ...
      public function clear_node(param1:ZPP_Set_ZPP_SimpleEvent, param2:Function) : ZPP_Set_ZPP_SimpleEvent
      {
         ...
         var _loc4_:ZPP_Set_ZPP_SimpleEvent = param1;
         _loc4_.data = null;
         _loc4_.lt = null;
         _loc4_.swapped = null;
         _loc4_.next = ZPP_Set_ZPP_SimpleEvent.zpp_pool;
         ...
         if(parent != null)
         {
            ...
            while(_loc1_ != null)
            {
               ...
               else
               {
                  ...
                  _loc3_.lt = null;
                  _loc3_.swapped = null;
                  _loc3_.next = ZPP_Set_ZPP_SimpleEvent.zpp_pool;
                  ZPP_Set_ZPP_SimpleEvent.zpp_pool = _loc3_;
                  §§push(_loc2_);
               }
               _loc1_ = §§pop();
            }
      ...
      public function __fix_neg_red(param1:ZPP_Set_ZPP_SimpleEvent) : void
      {
         ...
         var _loc3_:ZPP_Set_ZPP_SimpleEvent = §§pop();
