package zpp_nape.util
{
   ...
   public class ZPP_Set_ZPP_SimpleVert
   {
      
      public static var zpp_pool:ZPP_Set_ZPP_SimpleVert = null;
       
      
      public var swapped:Function;
      
      public var prev:ZPP_Set_ZPP_SimpleVert;
      
      public var parent:ZPP_Set_ZPP_SimpleVert;
      
      public var next:ZPP_Set_ZPP_SimpleVert;
      
      public var lt:Function;
      
      public var data:ZPP_SimpleVert;
      
      public var colour:int;
      
      public function ZPP_Set_ZPP_SimpleVert()
      {
      ...
      {
         var _loc1_:* = null as ZPP_Set_ZPP_SimpleVert;
         var _loc2_:* = null as ZPP_SimpleVert;
         var _loc3_:Boolean = false;
         var _loc4_:* = null as ZPP_Set_ZPP_SimpleVert;
         var _loc5_:* = null as ZPP_SimpleVert;
         if(!empty())
         {
            _loc1_ = parent;
      ...
      public function try_insert_bool(param1:ZPP_SimpleVert) : Boolean
      {
         var _loc2_:ZPP_Set_ZPP_SimpleVert = null;
         var _loc3_:ZPP_Set_ZPP_SimpleVert = null;
         if(parent == null)
         {
      ...
      public function try_insert(param1:ZPP_SimpleVert) : ZPP_Set_ZPP_SimpleVert
      {
         var _loc2_:ZPP_Set_ZPP_SimpleVert = null;
         var _loc3_:ZPP_Set_ZPP_SimpleVert = null;
         if(parent == null)
      ...
      public function successor_node(param1:ZPP_Set_ZPP_SimpleVert) : ZPP_Set_ZPP_SimpleVert
      {
      ...
      public function successor(param1:ZPP_SimpleVert) : ZPP_SimpleVert
      {
         var _loc2_:ZPP_Set_ZPP_SimpleVert = successor_node(find(param1));
      ...
      public function remove_node(param1:ZPP_Set_ZPP_SimpleVert) : void
      {
         var _loc2_:* = null as ZPP_Set_ZPP_SimpleVert;
         var _loc3_:* = null as ZPP_SimpleVert;
         var _loc4_:* = null as ZPP_Set_ZPP_SimpleVert;
         var _loc5_:* = null as ZPP_Set_ZPP_SimpleVert;
         ...
         _loc4_.lt = null;
         _loc4_.swapped = null;
         _loc4_.next = ZPP_Set_ZPP_SimpleVert.zpp_pool;
         ZPP_Set_ZPP_SimpleVert.zpp_pool = _loc4_;
      }
      
      public function remove(param1:ZPP_SimpleVert) : void
      {
         var _loc2_:ZPP_Set_ZPP_SimpleVert = find(param1);
         remove_node(_loc2_);
      }
      
      public function predecessor_node(param1:ZPP_Set_ZPP_SimpleVert) : ZPP_Set_ZPP_SimpleVert
      {
         var _loc2_:* = null as ZPP_Set_ZPP_SimpleVert;
         if(param1.prev != null)
         {
      ...
      public function predecessor(param1:ZPP_SimpleVert) : ZPP_SimpleVert
      {
         var _loc2_:ZPP_Set_ZPP_SimpleVert = predecessor_node(find(param1));
         return _loc2_ == null ? null : _loc2_.data;
      }
      
      public function pop_front() : ZPP_SimpleVert
      {
         var _loc1_:ZPP_Set_ZPP_SimpleVert = parent;
         while(_loc1_.prev != null)
         {
            _loc1_ = _loc1_.prev;
         }
         var _loc2_:ZPP_SimpleVert = _loc1_.data;
         remove_node(_loc1_);
         return _loc2_;
      }
      
      public function lower_bound(param1:ZPP_SimpleVert) : ZPP_SimpleVert
      {
         var _loc3_:* = null as ZPP_Set_ZPP_SimpleVert;
         var _loc4_:* = null as ZPP_SimpleVert;
         var _loc2_:ZPP_SimpleVert = null;
         if(!empty())
         {
            _loc3_ = parent;
      ...
      public function insert(param1:ZPP_SimpleVert) : ZPP_Set_ZPP_SimpleVert
      {
         var _loc2_:* = null as ZPP_Set_ZPP_SimpleVert;
         var _loc3_:* = null as ZPP_Set_ZPP_SimpleVert;
         if(ZPP_Set_ZPP_SimpleVert.zpp_pool == null)
      ...
      public function has_weak(param1:ZPP_SimpleVert) : Boolean
      {
         return find_weak(param1) != null;
      }
      
      public function has(param1:ZPP_SimpleVert) : Boolean
      {
         return find(param1) != null;
      }
      
      public function first() : ZPP_SimpleVert
      {
         var _loc1_:ZPP_Set_ZPP_SimpleVert = parent;
         while(_loc1_.prev != null)
         {
      ...
      public function find_weak(param1:ZPP_SimpleVert) : ZPP_Set_ZPP_SimpleVert
      {
         var _loc2_:ZPP_Set_ZPP_SimpleVert = parent;
         while(_loc2_ != null)
         {
      ...
      public function find(param1:ZPP_SimpleVert) : ZPP_Set_ZPP_SimpleVert
      {
         var _loc2_:ZPP_Set_ZPP_SimpleVert = parent;
      ...
      public function clear_node(param1:ZPP_Set_ZPP_SimpleVert, param2:Function) : ZPP_Set_ZPP_SimpleVert
      {
         param2(param1.data);
         var _loc3_:ZPP_Set_ZPP_SimpleVert = param1.parent;
         if(_loc3_ != null)
         {
         ...
         var _loc4_:ZPP_Set_ZPP_SimpleVert = param1;
         _loc4_.data = null;
         _loc4_.lt = null;
         _loc4_.swapped = null;
         _loc4_.next = ZPP_Set_ZPP_SimpleVert.zpp_pool;
         ...
         if(parent != null)
         {
            ...
            while(_loc1_ != null)
            {
               ...
               else
               {
                  ...
                  _loc3_.lt = null;
                  _loc3_.swapped = null;
                  _loc3_.next = ZPP_Set_ZPP_SimpleVert.zpp_pool;
                  ZPP_Set_ZPP_SimpleVert.zpp_pool = _loc3_;
                  §§push(_loc2_);
               }
               _loc1_ = §§pop();
            }
      ...
      public function __fix_neg_red(param1:ZPP_Set_ZPP_SimpleVert) : void
      {
         var _loc4_:* = null as ZPP_Set_ZPP_SimpleVert;
         var _loc5_:* = null as ZPP_Set_ZPP_SimpleVert;
         var _loc6_:* = null as ZPP_Set_ZPP_SimpleVert;
         var _loc7_:* = null as ZPP_Set_ZPP_SimpleVert;
         var _loc8_:int = 0;
         var _loc9_:* = null as ZPP_SimpleVert;
         var _loc2_:ZPP_Set_ZPP_SimpleVert = param1.parent;
         ...
         var _loc3_:ZPP_Set_ZPP_SimpleVert = §§pop();
      ...
      public function __fix_dbl_red(param1:ZPP_Set_ZPP_SimpleVert) : void
      {
         var _loc2_:* = null as ZPP_Set_ZPP_SimpleVert;
         var _loc3_:* = null as ZPP_Set_ZPP_SimpleVert;
         var _loc4_:* = null as ZPP_Set_ZPP_SimpleVert;
         ...
         var _loc6_:* = null as ZPP_Set_ZPP_SimpleVert;
         var _loc7_:* = null as ZPP_Set_ZPP_SimpleVert;
         var _loc8_:* = null as ZPP_Set_ZPP_SimpleVert;
         var _loc9_:* = null as ZPP_Set_ZPP_SimpleVert;
         var _loc10_:* = null as ZPP_Set_ZPP_SimpleVert;
