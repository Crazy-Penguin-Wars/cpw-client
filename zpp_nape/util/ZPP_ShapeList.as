package zpp_nape.util
{
   ...
   public class ZPP_ShapeList
   {
      ...
      public static function get(param1:ZNPList_ZPP_Shape, param2:Boolean = false) : ShapeList
      {
         var _loc3_:ShapeList = new ShapeList();
