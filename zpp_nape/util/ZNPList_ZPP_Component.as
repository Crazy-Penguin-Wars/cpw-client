package zpp_nape.util
{
   ...
   public class ZNPList_ZPP_Component
   {
      ...
      public function inlined_pop_unsafe() : ZPP_Component
      {
         var _loc1_:ZPP_Component = head.elt;
         pop();
         return _loc1_;
      ...
      public function inlined_insert(param1:ZNPNode_ZPP_Component, param2:ZPP_Component) : ZNPNode_ZPP_Component
      {
         var _loc4_:* = null as ZNPNode_ZPP_Component;
         if(ZNPNode_ZPP_Component.zpp_pool == null)
         {
      ...
      public function inlined_has(param1:ZPP_Component) : Boolean
      {
      ...
      public function inlined_erase(param1:ZNPNode_ZPP_Component) : ZNPNode_ZPP_Component
      {
      ...
      public function inlined_add(param1:ZPP_Component) : ZPP_Component
      {
         var _loc3_:* = null as ZNPNode_ZPP_Component;
         if(ZNPNode_ZPP_Component.zpp_pool == null)
         {
