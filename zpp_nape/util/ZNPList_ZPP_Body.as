package zpp_nape.util
{
   ...
   public class ZNPList_ZPP_Body
   {
      ...
      public function ZNPList_ZPP_Body()
      {
      ...
      public function try_remove(param1:ZPP_Body) : Boolean
      {
         ...
         var _loc3_:ZNPNode_ZPP_Body = head;
      ...
      public function reverse() : void
      {
         ...
         var _loc1_:ZNPNode_ZPP_Body = head;
         var _loc2_:ZNPNode_ZPP_Body = null;
         while(_loc1_ != null)
         {
            _loc3_ = _loc1_.next;
      ...
      public function remove(param1:ZPP_Body) : void
      {
         ...
         var _loc6_:* = null as ZNPNode_ZPP_Body;
         ...
         while(_loc3_ != null)
         {
            if(_loc3_.elt == param1)
            {
               ...
               _loc7_ = _loc5_;
               _loc7_.elt = null;
               _loc7_.next = ZNPNode_ZPP_Body.zpp_pool;
               ZNPNode_ZPP_Body.zpp_pool = _loc7_;
               modified = true;
               length = length - 1;
               pushmod = true;
               _loc6_;
      ...
      public function pop() : void
      {
         var _loc1_:ZNPNode_ZPP_Body = head;
         head = _loc1_.next;
         var _loc2_:ZNPNode_ZPP_Body = _loc1_;
         _loc2_.elt = null;
         _loc2_.next = ZNPNode_ZPP_Body.zpp_pool;
         ZNPNode_ZPP_Body.zpp_pool = _loc2_;
         if(head == null)
         {
            pushmod = true;
         }
      ...
      {
         var _loc2_:ZNPNode_ZPP_Body = head;
      ...
      public function insert(param1:ZNPNode_ZPP_Body, param2:ZPP_Body) : ZNPNode_ZPP_Body
      {
         ...
         {
            _loc4_ = new ZNPNode_ZPP_Body();
         }
         else
         {
            _loc4_ = ZNPNode_ZPP_Body.zpp_pool;
            ZNPNode_ZPP_Body.zpp_pool = _loc4_.next;
            _loc4_.next = null;
         }
         _loc4_.elt = param2;
         var _loc3_:ZNPNode_ZPP_Body = _loc4_;
         if(param1 == null)
         {
            _loc3_.next = head;
            head = _loc3_;
      ...
      public function inlined_erase(param1:ZNPNode_ZPP_Body) : ZNPNode_ZPP_Body
      {
         ...
         var _loc4_:ZNPNode_ZPP_Body = _loc2_;
         _loc4_.elt = null;
         _loc4_.next = ZNPNode_ZPP_Body.zpp_pool;
         ZNPNode_ZPP_Body.zpp_pool = _loc4_;
         modified = true;
         length = length - 1;
         pushmod = true;
         return _loc3_;
      ...
      {
         var _loc1_:* = null as ZNPNode_ZPP_Body;
         var _loc2_:* = null as ZNPNode_ZPP_Body;
         while(head != null)
         {
            _loc1_ = head;
      ...
      public function inlined_add(param1:ZPP_Body) : ZPP_Body
      {
         ...
         if(ZNPNode_ZPP_Body.zpp_pool == null)
         {
            _loc3_ = new ZNPNode_ZPP_Body();
         }
         else
         {
            _loc3_ = ZNPNode_ZPP_Body.zpp_pool;
            ZNPNode_ZPP_Body.zpp_pool = _loc3_.next;
            _loc3_.next = null;
         }
         _loc3_.elt = param1;
         var _loc2_:ZNPNode_ZPP_Body = _loc3_;
         _loc2_.next = head;
         head = _loc2_;
         modified = true;
         length = length + 1;
      ...
      {
         var _loc2_:ZNPNode_ZPP_Body = iterator_at(param1);
      ...
      public function addAll(param1:ZNPList_ZPP_Body) : void
      {
         ...
         var _loc2_:ZNPNode_ZPP_Body = param1.head;
         while(_loc2_ != null)
         {
            _loc3_ = _loc2_.elt;
            add(_loc3_);
