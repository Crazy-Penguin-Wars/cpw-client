package zpp_nape.util
{
   ...
   public class ZPP_Set_ZPP_CbSetPair
   {
      
      public static var zpp_pool:ZPP_Set_ZPP_CbSetPair = null;
      ...
      public function ZPP_Set_ZPP_CbSetPair()
      {
      ...
      {
         var _loc1_:* = null as ZPP_Set_ZPP_CbSetPair;
         var _loc2_:* = null as ZPP_CbSetPair;
         var _loc3_:Boolean = false;
         var _loc4_:* = null as ZPP_Set_ZPP_CbSetPair;
         var _loc5_:* = null as ZPP_CbSetPair;
         if(!empty())
         {
            _loc1_ = parent;
      ...
      {
         var _loc2_:ZPP_Set_ZPP_CbSetPair = null;
         var _loc3_:ZPP_Set_ZPP_CbSetPair = null;
         if(parent == null)
         {
            if(ZPP_Set_ZPP_CbSetPair.zpp_pool == null)
            {
               _loc2_ = new ZPP_Set_ZPP_CbSetPair();
            }
            else
            {
               _loc2_ = ZPP_Set_ZPP_CbSetPair.zpp_pool;
               ZPP_Set_ZPP_CbSetPair.zpp_pool = _loc2_.next;
               _loc2_.next = null;
            }
            _loc2_.data = param1;
            parent = _loc2_;
      ...
      {
         var _loc2_:* = null as ZPP_Set_ZPP_CbSetPair;
         if(param1.next != null)
         {
            param1 = param1.next;
      ...
      {
         var _loc2_:ZPP_Set_ZPP_CbSetPair = successor_node(find(param1));
      ...
      public function remove_node(param1:ZPP_Set_ZPP_CbSetPair) : void
      {
         ...
         var _loc3_:* = null as ZPP_CbSetPair;
         var _loc4_:* = null as ZPP_Set_ZPP_CbSetPair;
         var _loc5_:* = null as ZPP_Set_ZPP_CbSetPair;
         ...
         _loc4_.lt = null;
         _loc4_.swapped = null;
         _loc4_.next = ZPP_Set_ZPP_CbSetPair.zpp_pool;
         ZPP_Set_ZPP_CbSetPair.zpp_pool = _loc4_;
      }
      
      public function remove(param1:ZPP_CbSetPair) : void
      {
         var _loc2_:ZPP_Set_ZPP_CbSetPair = find(param1);
         remove_node(_loc2_);
      }
      ...
      {
         var _loc2_:ZPP_Set_ZPP_CbSetPair = predecessor_node(find(param1));
         return _loc2_ == null ? null : _loc2_.data;
      }
      
      public function pop_front() : ZPP_CbSetPair
      {
         var _loc1_:ZPP_Set_ZPP_CbSetPair = parent;
         while(_loc1_.prev != null)
         {
            _loc1_ = _loc1_.prev;
         }
         var _loc2_:ZPP_CbSetPair = _loc1_.data;
         remove_node(_loc1_);
         return _loc2_;
      }
      ...
      {
         var _loc2_:ZPP_Set_ZPP_CbSetPair = parent;
         while(_loc2_ != null)
         {
      ...
      {
         param2(param1.data);
         var _loc3_:ZPP_Set_ZPP_CbSetPair = param1.parent;
         if(_loc3_ != null)
         {
         ...
         var _loc4_:ZPP_Set_ZPP_CbSetPair = param1;
         _loc4_.data = null;
         _loc4_.lt = null;
         _loc4_.swapped = null;
         _loc4_.next = ZPP_Set_ZPP_CbSetPair.zpp_pool;
         ...
         if(parent != null)
         {
            ...
            while(_loc1_ != null)
            {
               ...
               else
               {
                  ...
                  _loc3_.lt = null;
                  _loc3_.swapped = null;
                  _loc3_.next = ZPP_Set_ZPP_CbSetPair.zpp_pool;
                  ZPP_Set_ZPP_CbSetPair.zpp_pool = _loc3_;
                  §§push(_loc2_);
               }
               _loc1_ = §§pop();
            }
      ...
      public function __fix_neg_red(param1:ZPP_Set_ZPP_CbSetPair) : void
      {
         var _loc4_:* = null as ZPP_Set_ZPP_CbSetPair;
         var _loc5_:* = null as ZPP_Set_ZPP_CbSetPair;
         var _loc6_:* = null as ZPP_Set_ZPP_CbSetPair;
         var _loc7_:* = null as ZPP_Set_ZPP_CbSetPair;
         var _loc8_:int = 0;
         var _loc9_:* = null as ZPP_CbSetPair;
         var _loc2_:ZPP_Set_ZPP_CbSetPair = param1.parent;
         ...
         var _loc3_:ZPP_Set_ZPP_CbSetPair = §§pop();
      ...
      public function __fix_dbl_red(param1:ZPP_Set_ZPP_CbSetPair) : void
      {
         ...
         var _loc6_:* = null as ZPP_Set_ZPP_CbSetPair;
         var _loc7_:* = null as ZPP_Set_ZPP_CbSetPair;
         var _loc8_:* = null as ZPP_Set_ZPP_CbSetPair;
         var _loc9_:* = null as ZPP_Set_ZPP_CbSetPair;
         var _loc10_:* = null as ZPP_Set_ZPP_CbSetPair;
         var _loc11_:* = null as ZPP_Set_ZPP_CbSetPair;
         while(true)
         {
