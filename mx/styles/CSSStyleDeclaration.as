   ...
   public class CSSStyleDeclaration extends EventDispatcher
   {
      ...
      public function CSSStyleDeclaration(selector:Object = null, styleManager:IStyleManager2 = null, autoRegisterWithStyleManager:Boolean = true)
      {
         ...
         if(Boolean(selector))
         {
            ...
            {
               this.mx_internal::selectorString = selector.toString();
            }
            if(autoRegisterWithStyleManager)
            {
               styleManager.setStyleDeclaration(this.mx_internal::selectorString,this,false);
            }
         }
      }
      ...
      {
         return Boolean(this._selector) ? this._selector.specificity : 0;
      }
      ...
      mx_internal function isAdvanced() : Boolean
      {
         ...
         {
            if(Boolean(this.selector.ancestor))
            {
               return true;
            }
            if(Boolean(this.selector.conditions))
            {
      ...
      {
         return this.selector != null ? this.selector.matchesStyleClient(object) : false;
      }
      ...
      mx_internal function equals(styleDeclaration:CSSStyleDeclaration) : Boolean
      {
         ...
         if(Boolean(ObjectUtil.compare(this.mx_internal::effects,styleDeclaration.mx_internal::effects)))
         {
            return false;
         }
         return true;
      ...
      public function setStyle(styleProp:String, newValue:*) : void
      {
         ...
         if(this.mx_internal::selectorRefCount > 0 && this.factory == null && this.defaultFactory == null && !this.overrides && oldValue !== newValue)
         {
            regenerate = true;
         }
      ...
      mx_internal function setLocalStyle(styleProp:String, value:*) : void
      {
         ...
         if(value is String)
         {
            ...
            colorNumber = Number(this.styleManager.getColorName(value));
         ...
         if(this.defaultFactory != null)
         {
            ...
            else if(Boolean(this.overrides))
            {
         ...
         this.mx_internal::updateClones(styleProp,value);
      }
      ...
      mx_internal function addStyleToProtoChain(chain:Object, target:DisplayObject, filterMap:Object = null) : Object
      {
         ...
         for each(style in parentStyleDeclarations)
         {
            ...
            {
               chain = style.mx_internal::addDefaultStyleToProtoChain(chain,target,filterMap);
            }
         }
         if(this.defaultFactory != null)
         {
         ...
         for each(style in parentStyleDeclarations)
         {
            ...
            {
               chain = style.mx_internal::addFactoryAndOverrideStylesToProtoChain(chain,target,filterMap);
      ...
      {
         if(Boolean(this.overrides) && this.overrides[styleProp] !== undefined)
         {
            delete this.overrides[styleProp];
         }
      }
