package mx.messaging
{
   ...
   public class MessageAgent extends EventDispatcher implements IMXMLObject
   {
      ...
      {
         this.mx_internal::internalSetChannelSet(value);
      ...
      protected function setConnected(value:Boolean) : void
      {
         ...
         if(this._connected != value)
         {
            ...
            dispatchEvent(event);
            this.mx_internal::setAuthenticated(value && Boolean(this.channelSet) && this.channelSet.authenticated,this._credentials);
         }
      }
      ...
      mx_internal function set needsConfig(value:Boolean) : void
      {
         ...
         if(this._needsConfig)
         {
            ...
            {
               this.mx_internal::internalSetChannelSet(cs);
            }
         }
      }
      ...
      public function acknowledge(ackMsg:AcknowledgeMessage, msg:IMessage) : void
      {
         ...
         if(this.mx_internal::configRequested)
         {
            this.mx_internal::configRequested = false;
            ServerConfig.mx_internal::updateServerConfigData(ackMsg.body as ConfigMap);
            this.mx_internal::needsConfig = false;
            if(Boolean(this._pendingConnectEvent))
            {
         ...
         if(this.clientId == null)
         {
            ...
            {
               this.mx_internal::setClientId(ackMsg.clientId);
            }
            else
            {
               this.flushClientIdWaitQueue();
      ...
      public function disconnect() : void
      {
         if(!this._disconnectBarrier)
         {
            ...
            {
               this.mx_internal::internalSetChannelSet(null);
            }
      ...
      public function fault(errMsg:ErrorMessage, msg:IMessage) : void
      {
         ...
         this.mx_internal::configRequested = false;
         if(Boolean(errMsg.headers[ErrorMessage.RETRYABLE_HINT_HEADER]))
         {
         ...
         if(this.clientId == null)
         {
            ...
            {
               this.mx_internal::setClientId(errMsg.clientId);
            }
            else
            {
               this.flushClientIdWaitQueue();
      ...
      public function channelConnectHandler(event:ChannelEvent) : void
      {
         ...
         if(this.mx_internal::needsConfig)
         {
            if(Log.isInfo())
            {
      ...
      protected function handleAuthenticationFault(errMsg:ErrorMessage, msg:IMessage) : void
      {
         ...
         if(errMsg.faultCode == "Client.Authentication" && this.authenticated && this.isCurrentChannelNotNull())
         {
            ...
            if(currentChannel is PollingChannel && (currentChannel as PollingChannel).mx_internal::loginAfterDisconnect)
            {
      ...
      protected function initChannelSet(message:IMessage) : void
      {
         if(this._channelSet == null)
         {
            ...
            this.mx_internal::internalSetChannelSet(ServerConfig.getChannelSet(this.destination));
         }
         if(this._channelSet.connected && this.mx_internal::needsConfig && !this.mx_internal::configRequested)
         {
            message.headers[CommandMessage.NEEDS_CONFIG_HEADER] = true;
            this.mx_internal::configRequested = true;
         }
         this._channelSet.connect(this);
      ...
      protected function internalSend(message:IMessage, waitForClientId:Boolean = true) : void
      {
         ...
         if(this.channelSet != null)
         {
            ...
            if(this.channelSet.connected && this.mx_internal::needsConfig && !this.mx_internal::configRequested)
            {
               message.headers[CommandMessage.NEEDS_CONFIG_HEADER] = true;
               this.mx_internal::configRequested = true;
            }
      ...
      private function monitorRpcMessage(message:IMessage, actualMessage:IMessage) : void
      {
         if(NetworkMonitor.isMonitoring())
         {
            ...
            {
               NetworkMonitor.monitorInvocation(this.mx_internal::getNetmonId(),message,this);
            }
         }
      }
