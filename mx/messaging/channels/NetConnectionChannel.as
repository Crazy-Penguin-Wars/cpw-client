      ...
      override protected function internalConnect() : void
      {
         ...
         if(this.mx_internal::_appendToURL != null)
         {
            ...
            if(i != -1)
            {
               ...
               url = url.replace(temp,temp + this.mx_internal::_appendToURL);
            }
            else
            {
               url += this.mx_internal::_appendToURL;
            }
         }
...
class NetConnectionMessageResponder extends MessageResponder
{
   ...
   override protected function resultHandler(msg:IMessage) : void
   {
      ...
      else
      {
         ...
         errorMsg.faultDetail = this.resourceManager.getString("messaging","noAckMessage.details",[Boolean(msg) ? msg.toString() : "null"]);
         errorMsg.correlationId = message.messageId;
         agent.fault(errorMsg,message);
      }
   }
