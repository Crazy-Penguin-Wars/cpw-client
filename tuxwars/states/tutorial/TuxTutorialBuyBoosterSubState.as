package tuxwars.states.tutorial
{
   ...
   public class TuxTutorialBuyBoosterSubState extends TuxTutorialSubState
   {
      ...
      {
         super(game,"TUTORIAL_BUY_BOOSTER");
      }
      ...
      override public function enter() : void
      {
         ...
         MessageCenter.addListener("BuyItem",boosterBought);
      }
      
      override public function exit() : void
      {
         super.exit();
         MessageCenter.removeListener("BuyItem",boosterBought);
      }
      ...
      private function boosterBought(msg:Message) : void
      {
         CRMService.sendEvent("Tutorial","Play_Tutorial","Clicked","BuyBooster","Shield");
