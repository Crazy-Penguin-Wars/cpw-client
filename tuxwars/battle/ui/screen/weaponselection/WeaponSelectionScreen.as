package tuxwars.battle.ui.screen.weaponselection
{
   ...
   public class WeaponSelectionScreen extends TuxPageSubTabScreen
   {
      ...
      public function WeaponSelectionScreen(param1:TuxWarsGame)
      {
         super(param1,DCResourceManager.instance.getFromSWF("flash/ui/ingame.swf","popup_choose_item"),WeaponSelectionLogic.getStaticData());
      ...
      private function initSubTabObjectContainer() : void
      {
         ...
         var _loc1_:Row = this.weaponSelectionLogic.getCurrentTab();
         ...
         this._objectContainer.init(this.weaponSelectionLogic.getItemsNoVIP(_loc4_,_loc5_),true);
      }
      ...
      {
         this.weaponSelectionLogic.exit();
      }
