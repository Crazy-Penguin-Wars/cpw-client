package tuxwars.battle.net
{
   public class SocketMessageTypes
   {
      ...
      public static function isBattleMessage(param1:int) : Boolean
      {
         return BATTLE_MESSAGES.indexOf(param1) != -1;
      }
      
      public static function isControlMessage(param1:int) : Boolean
      {
         return CONTROL_MESSAGES.indexOf(param1) != -1;
      }
