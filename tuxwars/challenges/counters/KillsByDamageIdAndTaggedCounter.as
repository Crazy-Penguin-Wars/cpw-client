package tuxwars.challenges.counters
{
   ...
   {
      public function KillsByDamageIdAndTaggedCounter(param1:Challenge, param2:String, param3:int, param4:String, param5:ChallengeParamReference)
      {
      ...
      override public function handlePlayerDied(param1:ChallengePlayerDiedMessage) : void
      {
         ...
         {
            if(Boolean(_loc5_) && _loc8_._id == _loc9_._id)
            {
               if(_loc4_.tag.hasPlayerIDInTag(playerId,_loc5_))
               {
                  if(params)
                  {
