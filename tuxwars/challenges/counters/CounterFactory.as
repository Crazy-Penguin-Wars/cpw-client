package tuxwars.challenges.counters
{
   ...
   public class CounterFactory
   {
      ...
      public static function createCounter(param1:Challenge, param2:String, param3:int, param4:String, param5:*) : Counter
      {
         var _loc6_:String = null;
         if(isSpecialCounter(param2))
         {
            _loc6_ = getBaseId(param2);
            if(COUNTER_MAP.hasOwnProperty(_loc6_))
            {
               return new COUNTER_MAP[_loc6_](param1,param2,param3,param4,param5);
            }
         }
         if(COUNTER_MAP.hasOwnProperty(param2))
         {
            return new COUNTER_MAP[param2](param1,param2,param3,param4,param5);
         }
         LogUtils.log("Trying to create a unknown counter: " + param2,"CounterFactory",3,"Challenges",false,false,true);
         return null;
      }
      
      public static function isBooleanClass(param1:String) : *
      {
         return BOOLEAN_COUNTER_MAP[param1] != null;
      }
      
      private static function isSpecialCounter(param1:String) : Boolean
      {
         var _loc2_:String = getBaseId(param1);
         return SPECIAL_COUNTERS.indexOf(_loc2_) != -1;
      }
      
      private static function getBaseId(param1:String) : String
      {
