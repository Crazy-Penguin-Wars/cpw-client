package tuxwars.challenges.counters
{
   ...
   public class BuyItemClothingCounter extends Counter
   {
       
      
      public function BuyItemClothingCounter(challenge:Challenge, id:String, targetValue:int, playerId:String, params:*)
      {
