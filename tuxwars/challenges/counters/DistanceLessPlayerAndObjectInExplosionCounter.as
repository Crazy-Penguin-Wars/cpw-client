package tuxwars.challenges.counters
{
   ...
   {
      public function DistanceLessPlayerAndObjectInExplosionCounter(param1:Challenge, param2:String, param3:int, param4:String, param5:ChallengeParamReference)
      {
