package org.as3commons.zip
{
   ...
   public class Zip extends EventDispatcher
   {
      ...
      public function Zip(param1:String = "utf-8")
      {
         super();
      ...
      public function serialize(param1:IDataOutput, param2:Boolean = false) : void
      {
         ...
         if(param1 != null && this.filesList.length > 0)
         {
            ...
            {
               _loc8_ = this.filesList[_loc7_] as ZipFile;
               if(_loc8_ != null)
               {
      ...
      {
         return Boolean(this.filesList) ? uint(this.filesList.length) : 0;
      }
      
      public function getFileAt(param1:uint) : ZipFile
      {
         return Boolean(this.filesList) ? this.filesList[param1] as ZipFile : null;
      }
      
      public function getFileByName(param1:String) : ZipFile
      {
         return Boolean(this.filesDict[param1]) ? this.filesDict[param1] as ZipFile : null;
      }
      
      public function addFile(param1:String, param2:ByteArray = null, param3:Boolean = true) : ZipFile
      {
         return this.addFileAt(Boolean(this.filesList) ? uint(this.filesList.length) : 0,param1,param2,param3);
      }
      
      public function addFileFromString(param1:String, param2:String, param3:String = "utf-8", param4:Boolean = true) : ZipFile
      {
         return this.addFileFromStringAt(Boolean(this.filesList) ? uint(this.filesList.length) : 0,param1,param2,param3,param4);
      }
      
      public function addFileAt(param1:uint, param2:String, param3:ByteArray = null, param4:Boolean = true) : ZipFile
      {
         ...
         else if(Boolean(this.filesDict[param2]))
         {
            throw new Error("File already exists: " + param2 + ". Please remove first.");
         }
         var _loc5_:ZipFile = new ZipFile();
      ...
      public function addFileFromStringAt(param1:uint, param2:String, param3:String, param4:String = "utf-8", param5:Boolean = true) : ZipFile
      {
         if(this.filesList == null)
         {
            this.filesList = [];
         ...
         var _loc6_:ZipFile = new ZipFile();
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case SIG_LOCAL_FILE_HEADER:
                  ...
                  this.currentFile = new ZipFile(this.charEncoding);
                  break;
      ...
      protected function onFileLoaded() : void
      {
         ...
         dispatchEvent(new ZipEvent(ZipEvent.FILE_LOADED,this.currentFile));
